...
func InitPublicRoutes(router fiber.Router, profileController *controller.ProfileController) {
	...
	router.Get("/profiles/:sessionId/session", profileController.GetProfileBySessionId())
	router.Get("/profiles/:sessionId/detail", profileController.GetProfileDetail())
	router.Get("/profiles/:sessionId/short", profileController.GetProfileShortInfo())
	...
	router.Get("/profiles/:sessionId/filter", profileController.GetFilterBySessionId())
